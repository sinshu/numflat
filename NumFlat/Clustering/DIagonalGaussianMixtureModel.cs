...
{
    /// <summary>
    /// Provides the diagonal Gaussian mixture model.
    /// </summary>
    public class DiagonalGaussianMixtureModel : IProbabilisticClassifier<double>, IMultivariateDistribution<double>
    {
        private readonly Component[] components;

        private DiagonalGaussianMixtureModel(Component[] components)
        {
            this.components = components;
        }

        /// <summary>
        /// Initializes a new diagonal Gaussian mixture model by the given Gaussian components.
        /// </summary>
        ...
        public DiagonalGaussianMixtureModel(IReadOnlyList<Vec<double>> xs, int clusterCount, double regularization = 1.0E-6, int kMeansTryCount = 3, Random? random = null)
        {
            ...
            if (clusterCount == 1)
            {
                this.components = new Component[] { new Component(1.0, xs.ToDiagonalGaussian(regularization)) };
                return;
            }
        ...
        public class Component
        {
            ...
            private DiagonalGaussian gaussian;
            ...
            /// </param>
            public Component(double weight, DiagonalGaussian gaussian)
            {
            ...
            /// </summary>
            public DiagonalGaussian Gaussian => gaussian;
        }
    }
}
