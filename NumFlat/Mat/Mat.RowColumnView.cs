        ...
        public readonly struct RowList : IReadOnlyList<Vec<T>>
        {
            ...
            public readonly Vec<T> this[int index]
            {
                get
                {
                    ...
                    {
                        throw new ArgumentOutOfRangeException(nameof(index), $"The row index '{index}' is outside the matrix, whose row count is '{mat.rowCount}'.");
                    }
        ...
        public readonly struct ColList : IReadOnlyList<Vec<T>>
        {
            ...
            public readonly Vec<T> this[int index]
            {
                get
                {
                    ...
                    {
                        throw new ArgumentOutOfRangeException(nameof(index), $"The column index '{index}' is outside the matrix, whose column count is '{mat.colCount}'.");
                    }
