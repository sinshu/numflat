...
namespace NumFlat.SignalProcessing
{
    public static partial class SignalProcessing
    {
        ...
        public static void Resample(in Vec<double> source, in Vec<double> destination, int p, int q, int a = 10)
        {
            ...
            if (q == 1 && p > 1)
            {
                UpsampleByConvolution(src, dst, p, a);
            }
            else if (p == 1 && q > 1)
            {
                DownsampleByConvolution(src, dst, q, a);
            }
            else
            {
        ...
        private static void UpsampleByConvolution(in Vec<double> source, in Vec<double> destination, int p, int a)
        {
        ...
        private static void DownsampleByConvolution(in Vec<double> source, in Vec<double> destination, int q, int a)
        {
