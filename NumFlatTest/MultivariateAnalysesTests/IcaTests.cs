...
namespace NumFlatTest.MultivariateAnalysesTests
{
    public class IcaTests
    {
        ...
        public void In2_Out2()
        {
            ...
            var ica = xs.Cols.Ica(2, null, new Random(42));
        ...
        public void In3_Out3()
        {
            ...
            var ica = xs.Cols.Ica(3, null, new Random(57));
        ...
        public void In4_Out3()
        {
            ...
            var ica = xs.Cols.Ica(3, null, new Random(66));
        ...
        public void In5_Out2()
        {
            ...
            var ica = xs.Cols.Ica(2, null, new Random(77));
