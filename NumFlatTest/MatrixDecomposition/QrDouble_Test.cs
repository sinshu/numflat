...
namespace NumFlatTest
{
    public class QrDouble_Test
    {
        ...
        public void Determinant(int n)
        {
            ...
            Assert.That(a.Qr().Determinant(), Is.EqualTo(Math.Abs(a.Determinant())).Within(1.0E-12));
            Assert.That(a.Qr().LogDeterminant(), Is.EqualTo(Math.Log(Math.Abs(a.Determinant()))).Within(1.0E-12));
        }
